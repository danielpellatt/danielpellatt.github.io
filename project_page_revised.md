...
4. Two XGBoost extensions showed gross-return promise, but did not produce robust net-of-cost improvement on the final holdout; turnover and spread-cost drag were especially important for the ML variants.
...
- Before forming portfolio weights, I project the final ML signal onto the orthogonal complement of the estimated beta-loading space. This removes the part of the signal associated with estimated common-factor exposures, preserving the Kim et al. baseline’s hedge-risk-first logic.
